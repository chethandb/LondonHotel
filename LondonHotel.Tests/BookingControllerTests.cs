   ...
   public  class BookingControllerTests
    {
        ...
        public void IndexPost_CalculatesPrice_WithCheckInDate()
        {
            ...
            service.Index(new BookingViewModel { CheckInDate = DateTime.MinValue, RoomId = 1 });
        ...
        public void IndexPost_CalculatesPrice_WithCheckOutDate()
        {
            ...
            service.Index(new BookingViewModel { CheckOutDate = DateTime.MaxValue, RoomId = 1 });
        ...
        public void IndexPost_CalculatesPrice_WithCouponCode()
        {
            ...
            service.Index(new BookingViewModel { CouponCode = "FREEMONEY", RoomId = 1 });
